        ...
        <div class="hidden lg:fixed lg:inset-y-0 lg:z-50 lg:flex lg:w-72 lg:flex-col">
            <div class="flex grow flex-col gap-y-5 overflow-y-auto  border-r border-gray-300 px-6 pb-4 pt-8">
                <div class="flex shrink-0 items-center">
                    <div class="hover:bg-gray-100 flex gap-x-1 rounded-md p-2 text-sm leading-6 items-center">
                    ...
                    <ul role="list" class="flex flex-1 flex-col gap-y-7">
                        <li>
                            <ul role="list" class="-mx-2 space-y-1">
                                <li v-for="item in navigation" :key="item.name">
                                    <a :href="item.href"
                                        class="group flex gap-x-3 rounded-md p-2 text-sm font-semibold leading-6 items-center">
                        ...
                        <li class="mt-auto">
                            <div class="grid gap-1">
                                <a href="#"
                                    class="group -mx-2 flex justify-start gap-x-3 rounded-md px-2 text-xs items-center font-semibold leading-6 hover:bg-gray-100">
                                    <i class="material-icons text-sm">loyalty</i>
                                    Plan & subscription
                                    <span class="ltr ml-auto">Tier 4</span>
                                </a>
                                <a href="#"
                                    class="group -mx-2 flex gap-x-3 rounded-md px-2 text-xs items-center font-semibold leading-6 hover:bg-gray-100">
                ...
                <div class="flex flex-1 justify-end">
                    <span class="isolate inline-flex rounded-md">
                        <div class="relative">
                            ...
                            <input
                                class="block w-full border-0 py-1 pl-10 h-9 rounded-l-md text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:outline-none  sm:text-sm sm:leading-6"
