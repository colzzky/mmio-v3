...
<template>
    ...
    <div v-if="componentDataLoaded && !componentLoad" class="flex flex-col gap-y-4">
        ...
        <div class="flex flex-col gap-y-2">
            ...
            <Input v-model="inputField.dataInput.street" @blur="inputField.validateSingleField('street')" type="text"
                name="street" id="street" placeholder="147 Chance Plain" class="h-7 text-xs" />
            <div v-if="inputField.errors.street" for="name" class="text-xs text-red-500 flex items-center gap-1">
        ...
        <div class="flex flex-col gap-y-2">
            ...
            <Input v-model="inputField.dataInput.city" @blur="inputField.validateSingleField('city')" type="text"
                name="street" id="city" placeholder="Delphiaworth" class="h-7 text-xs" />
            <div v-if="inputField.errors.city" for="name" class="text-xs text-red-500 flex items-center gap-1">
                <i class="material-icons text-sm">error</i>
        ...
        <div class="flex flex-col gap-y-2">
            ...
            <Input v-model="inputField.dataInput.state" @blur="inputField.validateSingleField('state')" type="text"
                name="street" id="state" placeholder="Rhose Island" class="h-7 text-xs" />
            <div v-if="inputField.errors.state" for="name" class="text-xs text-red-500 flex items-center gap-1">
                <i class="material-icons text-sm">error</i>
        ...
        <div class="flex flex-col gap-y-2">
            ...
            <Input v-model="inputField.dataInput.country" @blur="inputField.validateSingleField('country')" type="text"
                name="street" id="country" placeholder="United States" class="h-7 text-xs" />
            <div v-if="inputField.errors.country" for="name" class="text-xs text-red-500 flex items-center gap-1">
                <i class="material-icons text-sm">error</i>
        ...
        <div class="flex flex-col gap-y-2">
            ...
            <Input v-model="inputField.dataInput.zipCode" @blur="inputField.validateSingleField('zipCode')" type="text"
                name="street" id="zipCode" placeholder="72801-5565" class="h-7 text-xs" />
            <div v-if="inputField.errors.zipCode" for="name" class="text-xs text-red-500 flex items-center gap-1">
                <i class="material-icons text-sm">error</i>
                {{ inputField.errors.zipCode }}
            </div>
        </div>
        <Button class="self-end text-xs" size="xs" @click="inputField.validateDataInput()">Update</Button>
    </div>
    ...
    <Dialog v-model:open="inputField.confirmationModal">
        <DialogContent @interact-outside="(e) => e.preventDefault()">
            <div class="relative">
                <button @click="inputField.openCloseConfirmation()" :disabled="inputField.isLoading"
                ...
                <DialogFooter class="pt-4">
                    <div>
                        <div v-if="!inputField.isLoading" class="flex items-center justify-end gap-2">
                            ...
                            <Button variant="outline" size="xs" @click="inputField.updateAddress()"> Confirm
                            </Button>
                        </div>
