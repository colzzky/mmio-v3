...
import type { PostRandomizerPostsData, PostRandomizerServiceData } from '@/core/types/WorkSpaceTypes';
import { getExact, getWhereAny } from '@/core/utils/firebase-collections';
...
const { workspace_service, active_workspace, active_team } = authWorkspaceStore
            ...
            <div class="">
                <div class="w-full space-y-4">
                    <div class='flex justify-end items-center space-x-4'>
                        ...
                        <Button
                            @click="createEditPostRef?.modal.open({ intent: 'create', prId: campaign_data.pr_id, postData: null })">
                            Create New Post
                        </Button>
                    </div>
                    ...
                    <div v-if="!campaign_contents.fetchLoad" class="py-2">
                        <div v-if="campaign_contents.data.length">
                            <div v-for="post in campaign_contents.data" :key="post.prp_id"
                                ...
                                <div class="grid grid-cols-12 items-center">
                                    ...
                                    <div class="col-span-3 flex flex-col">
                                        <span class="text-sm">
                                            {{
                                                post.createdBy ?
                                                    active_team.members[post.createdBy].displayName : post.createdBy
                                            }}
                                        </span>
                                    </div>
                                        ...
                                        <div class="grid place-content-center">
                                            <DropdownMenu>
                                                ...
                                                <DropdownMenuContent>
                                                    ...
                                                    <DropdownMenuItem class="gap-x-3"
                                                        @click="createEditPostRef?.modal.open({ intent: 'edit', prId: campaign_data.pr_id, postData: post })">
                                                        <i class="bx bx-edit text-xl" />
                                                        Edit
                                                    </DropdownMenuItem>
                                                </DropdownMenuContent>
