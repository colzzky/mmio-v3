        ...
        <TableRow v-for="[campaignId, campaign] in campaigns" :key="campaignId">
          ...
          <TableCell>
            <div class="5 flex flex-col gap-y-0">
              ...
              <div><strong>Groups: </strong>{{ campaign.publishedTo?.groups ?? 'No Target' }}</div>
            </div>
          </TableCell>
          <TableCell>
            ...
            <div class="grid place-content-center">
              <DropdownMenu>
                ...
                <DropdownMenuContent>
                  ...
                  <DropdownMenuItem class="gap-x-3" @click="handleToggleCampaignStatus(campaignId)">
                    <i
                      :class="[
                        'bx text-xl',
                  ...
                  <DropdownMenuItem class="gap-x-3" @click="deleteModalRef?.modal.open(campaignId)">
