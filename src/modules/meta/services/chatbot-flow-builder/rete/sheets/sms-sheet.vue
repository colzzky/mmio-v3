...
<template>
  <template v-if="localNodeData && localNodeData.data">
    ...
    >
      ...
      <SheetDescription class="leading-none">SMS</SheetDescription>
    </SheetHeader>
    <main class="grid gap-y-4 px-6 py-3">
      ...
      <div class="flex flex-col gap-y-2">
        <Label>Your Credit Estimate</Label>
        <strong class="text-center text-yellow-500">300 Credits</strong>
      </div>
      <div>
        ...
        <small class="text-xs text-muted-foreground">
          Count: {{ localNodeData.data.text.length }}/700
        </small>
      </div>
      <div>
        ...
        <Select>
          ...
          <SelectContent>
            <SelectGroup>
              <SelectItem value="sender-id-1">Sender ID #1</SelectItem>
              <SelectItem value="sender-id-2">Sender ID #2</SelectItem>
              <SelectItem value="sender-id-3">Sender ID #3</SelectItem>
            </SelectGroup>
          </SelectContent>
        </Select>
      </div>
