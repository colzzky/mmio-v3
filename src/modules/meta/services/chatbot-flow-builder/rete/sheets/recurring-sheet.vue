  ...
  <template v-if="localNodeData && localNodeData.data">
    ...
    <template v-if="sheetState === 'default'">
      ...
      >
        ...
        <SheetDescription class="leading-none">Recurring</SheetDescription>
      </SheetHeader>
          ...
          >
            ...
            <SelectContent>
              <SelectGroup>
                ...
                <SelectItem value="user_email">User Function</SelectItem>
