...
<template>
  <div class="space-y-5">
    <div>
      ...
      >
        ...
        <button
          ...
          type="button"
          @click="
            sheetState !== 'create-reply-button'
              ? handleChangeSheetState('main')
              : handleChangeSheetState('create-card')
          "
          class="row-span-full"
        ...
        <small class="leading-none text-muted-foreground">
          Generic Node
          <template v-if="sheetState === 'create-card'"> > Create Card </template>
    ...
    <main v-else-if="sheetState === 'create-card'" class="grid gap-y-6 text-sm">
      ...
      >
        <img
          v-if="card_form.data.image"
          :src="card_form.data.image"
    ...
    <main v-else-if="sheetState === 'create-reply-button'" class="grid gap-y-6 text-sm">
      <section class="grid gap-y-1.5">
        ...
        <Input
          v-model="card_form.button.title"
          type="text"
          name="buttonName"
