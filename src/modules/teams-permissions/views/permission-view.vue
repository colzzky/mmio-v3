...
<template>
                        ...
                        <div
                            ...
                            <div class="px-5 py-5 space-y-4">
                                ...
                                <div class="space-y-2">
                                    ...
                                    <div
                                        v-if="selected_permission.data.assignment[key].custom && selected_permission.data.assignment[key].access.includes(Access_levels.CUSTOM)">
                                        <div class="pt-4 pb-2">
                                            <span class="text-lg">Custom:</span>
                                        </div>
                                        <div class="space-y-2">
                                            <div v-for="(custom_val, custom_key) in selected_permission.sortCustomPermission(selected_permission.data.assignment[key].custom)"
                                                class="grid grid-cols-6">
                                                <span class="col-span-2 text-sm font-semibold">{{ custom_key }}:</span>
                                                <div class="col-span-4">
                                                    <RadioGroup
                                                        :default-value="selected_permission.data.assignment[key].custom[custom_key] ? 'Yes' : 'No'"
                                                        orientation='horizontal'
                                                        @update:model-value="selected_permission.change_custom_permission(key, custom_key)"
    ...
    <div v-else>
        <div class="bg-gray-100 border-gray-200 rounded-lg p-4">
            Loading....
        </div>
    </div>
</template>