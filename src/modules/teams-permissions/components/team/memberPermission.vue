...
import { Access_levels, admin_access, custom_access, custom_permission, default_access, Permission_Services, type AccessStructure, type CustomPermissions, type PermissionData } from '@/core/types/PermissionTypes'
...
<template>
    <Dialog v-model:open="member_permission_modal.isOpen">
        <DialogContent @interact-outside="(e) => e.preventDefault()" class="sm:max-w-[75%]">
            <div class="container mx-auto space-y-5 py-4">
                ...
                <div class="space-y-3">
                    <div class="flex space-x-4 items-center">
                        ...
                        <Button v-if="!current_permission.saveLoad" variant="outline" size="sm"
                            class="flex items-center gap-2" @click="member_permission_modal.save_access_permission()">
                    ...
                    <div class="grid grid-cols-3">
                        <div class="col-span-1 flex flex-col gap-4">
                            <Button @click="current_permission.set_permission('default')" class="text-red-500"
                                variant="outline" size="xs">
                                Set Permission to default/member
                            </Button>
                            <Button @click="current_permission.set_permission('admin')" class="text-red-500"
                                variant="outline" size="xs">
                                Set Permission to Admin
                            </Button>
                            <Button @click="current_permission.set_permission('custom')" class="text-red-500"
                                variant="outline" size="xs">
                                Button set custom permission
                            </Button>
                        </div>
                        <div class="col-span-2 bg-gray-100 border-gray-200 rounded-lg py-4">
                            <div v-if="!current_permission.saveLoad">
                                <div v-for="custom, key in custom_access">
                                    <div
                                                ...
                                                <div
                                                    ...
                                                    <div class="space-y-2">
                                                        <div v-for="(custom_val, custom_key) in current_permission.sortCustomPermission(current_permission.data[key].custom)"
                                                            ...
                                                            <span class="col-span-2 text-sm font-semibold">{{ custom_key
                                                                }}:</span>
