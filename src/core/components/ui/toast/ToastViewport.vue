...
<template>
  <ToastViewport v-bind="delegatedProps" :class="cn('fixed top-0 left-[50%] z-[100] flex max-h-screen w-full translate-x-[-50%] flex-col-reverse p-4 sm:right-0 sm:flex-col md:max-w-[420px]', props.class)" />
