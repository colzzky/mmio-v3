      ...
      >
        ...
        <div class="flex flex-col gap-y-1">
          <RouterLink
            ...
            :key="link.href"
            :to="link.href"
            class="grid grid-cols-[var(--icon-size),1fr] items-center gap-x-4 rounded px-4 py-2.5 text-sm font-medium transition-colors [--icon-size:20px] hover:bg-primary/50 hover:text-primary-foreground aria-[current=page]:bg-primary aria-[current=page]:text-primary-foreground"
          >
